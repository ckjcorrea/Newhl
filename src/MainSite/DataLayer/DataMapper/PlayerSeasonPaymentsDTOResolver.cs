...
{
    class PlayerSeasonPaymentsDTOResolver : MappedListResolver<Payment, DTO.Payment>
    {
        protected override IList<DTO.Payment> GetDestinationList(ResolutionResult source)
        {
            return ((DTO.PlayerSeason)source.Context.DestinationValue).Payments;
        }
        ...
        protected override IList<Payment> GetSourceList(ResolutionResult source)
        {
            ...
            {
                retVal = ((PlayerSeason)source.Value).Payments;
            }
